...
module ThreadAgent
  module Slack
    # Base class for shared setup - NO TESTS HERE
    ...
    # Main service tests - inherits from base but contains the actual service tests
    class ServiceTest < ServiceTestBase
      ...
      class ValidateWebhookTest < ServiceTestBase
        def setup
          super
      ...
      class PayloadStructureValidationTest < ServiceTestBase
        def setup
          super
          @valid_timestamp = Time.now.to_i.to_s
        end
      ...
      class ModalCreationTest < ServiceTestBase
        def setup
          super
      ...
      class FetchThreadRetryTest < ServiceTestBase
        def setup
          super
      ...
      class CreateModalRetryTest < ServiceTestBase
        def setup
          super
          @trigger_id = "12345.98765.abcd2358fdea"
      ...
      class HandleModalSubmissionTest < ServiceTestBase
        def setup
          super
        end
